        ...
        <table> 
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="editSec.php?id=<?= $row['id'] ?>" id="ed">
                            <ion-icon name="create"></ion-icon>
                        </a>
                        <a href="deleteSec.php?id=<?= $row['id'] ?>" id="del">
...
<div class="popup-overlay" id="popup-overlay">
        <div class="popup-form" id="popup-form">
            <form id="add-secretaire-form" method="post">
                <h2>Add Secretaire</h2>
                ...
                <input type="password" id="email" name="password1"><br>
